...
qui comprend une version PDF du \textit{Manuel FlightGear}, qui a \'{e}t\'{e} con\c{c}u pour un affichage et une impression de qualit\'{e} en utilisant le logiciel Acrobat Reader d'Adobe, disponible \`{a} l'adresse :
}{}
...
Enfin, le code source comporte un r\'{e}pertoire \texttt{docs-mini} qui contient de nombreuses id\'{e}es et solutions pour des probl\`{e}mes particuliers. Il s'agit donc \'{e}galement d'un bon endroit pour trouver de la lecture int\'{e}ressante.
}{}
