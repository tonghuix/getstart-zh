...
%%
%% $Id: prefligh.tex,v 0.5 2002/15/02 michael
...
Mac OS X requires that you first download the base püackage. Then extract it with
...
Olson\index{Olson, Curt} which can be downloaded via a clickable map at
 \medskip
...
For installing these files, you have to unpack them under \texttt{/Flightgear/Scenery}.
Do not de-compress the numbered scenery files like 958402.gz! This will be done by
\FlightGear{} on the fly.
