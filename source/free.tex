...
\ifchinese
以上所列都是我们为什么要创建 \FlightGear{}。正是因为有了这些想法，我们创建一个高质量的飞行模拟器。打造一个针对民用航空，\index{Flight simulator!civilian}跨平台的，\index{Flight simulator!multi-platform}开放的，\index{Flight simulator!open}用户支持的，\index{Flight simulator!user-supported}以及用户可扩展的，\index{Flight
