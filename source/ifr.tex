...
现在你已经回到了 255$^\circ$，减速到 75 节，放出一档位襟翼（10度），并下降到 2800 英尺并保持（不要低于此高度）\marginpar{\textsf{减速到 75 节；放出一档襟翼；下降到 2800}}。通过检查 FOOTO 确认我们进场的位置。现在抬头挺胸迎接落地。
...
\marginpar{\textsf{截获下滑道；穿过外指；放出第二档位襟翼}}
