...
% Note: the full command line is:
% ./fgfs.sh --airport=KRHV --timeofday=noon --runway=31R --ceiling=750:3000 --visibility-miles=1 --prop:/environment/config/aloft/entry/visibility-m\[0\]=30000
...
glide slope).\marginpar{\textsf{Intercept glideslope; cross outer
    marker; drop second notch of flaps}}
...
been in view soon after\marginpar{\textsf{Sight runway; disengage
    autopilot; cross middle marker}}.  With the runway in sight, you
...
bouncing around and cursing)\marginpar{\textsf{Land; eat hamburger}}.
