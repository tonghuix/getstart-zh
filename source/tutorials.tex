...
除了此指南，还有一份由 David Megginson\index{Megginson, David} （\FlightGear{} 的主要开发者之一）写的非常棒的教程，教你如何用 \FlightGear{} 完成一个机场起落航线（五边航线）。此教程有很多截图和大量资料，可在此处找到：
\fi
\iffalse
\IfLanguageName{english}{
...
\ifchinese
里面包含所有和飞行相关的信息，从飞行原理和飞机结构讲起，再到起飞降落和紧急情况处理。这非常适用于那些希望学习基本飞行知识，但又不想购买昂贵的纸质飞行员手册的人。
