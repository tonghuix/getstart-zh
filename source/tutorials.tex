...
When the simulator has loaded, select Start Tutorial from the Help menu.

For simplicity, run the Cessna 172p tutorials with AI aircraft turned off. Otherwise, ATC messages 
