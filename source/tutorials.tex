...
\iflanguage{french}{
Si voler est pour vous quelque chose de nouveau, l'utilisation d'un simulateur avancé comme \FlightGear{} peut sembler
...
mettre le tutoriel en pause \`{a} n'importe quel moment en appuyant sur la touche `p' key. Pour arr\^{e}ter le tutoriel,
