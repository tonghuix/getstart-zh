...
\begin{itemize}
 ...
 \item \textbf{Print} Exits\index{exit} the program.
...
\item \textbf{Save flight} Saves\index{save flight} the current flight, by default to \texttt{fgfs-screen-XXX.ppm}.
 \item \textbf{Load flight} Loads\index{load flight} the current flight, by default from \texttt{fgfs-screen-XXX.ppm}.
  \end{itemize}
...
\item \textbf{Environment}
 ...
 \begin{itemize}
 \item \textbf{Help} Opens your \Index{browser} and displays and overview on several help options (including links to this Guide as well as to the FAQ).
 \end{itemize}
\end{itemize}
