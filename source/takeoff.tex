...
\medskip
\IfLanguageName{italian}{
Fig.\,3 : Pronti al decollo: avvio predefinito a San Francisco Intl, KSFO.}
}{}
\medskip
...
\IfLanguageName{italian}{
  ...
  \item{\texttt{-$ $-control={\it MODALIT\`{A}}}}

    Specifica la \Index{modalit\`{a} di controllo} primario
    (\Index{\texttt{joystick}},  \texttt{keyboard}, \texttt{mouse})
    la predefinita \`{e} \Index{joystick}.
