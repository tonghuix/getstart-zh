...
Options are \texttt{jsb, larcsim, yasim, magic, balloon, null (for external
FDM), ada, null}. Default value is
...
\item{\texttt{-$ $-heading={\it degrees}}}: Sets the \Index{initial heading} (yaw angle) in degrees.
  This can be used to specify the end of a runway you'd like to start from.
\item{\texttt{-$ $-runway-id={\it XY}}}: Sets the runway ID you'd like to
  start from (useful in case the airport has different parallel runways).
