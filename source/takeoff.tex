...
(typically something like \texttt{c:$\backslash$Program Files$\backslash$FlightGear$\backslash$Win32$\backslash$bin}), 
set the \Index{environment variables} by typing 
\medskip
...
\item{\texttt{-$ $-disable-auto-coordination}}
  ...
  Switches \Index{auto coordination} between aileron/rudder off (default).
