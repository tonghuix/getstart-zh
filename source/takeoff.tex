...
En activant T\'{e}l\'{e}charger les sc\`{e}nes \`{a} la vol\'{e}e dans la fen\^{e}tre de l'assistant, les sc\`{e}nes seront t\'{e}l\'{e}charg\'{e}es grace \`{a} \Terrasync{} lorsque vous volerez. L'utilitaire de t\'{e}l\'{e}chargement des sc\`{e}nes installera les donn\'{e}es de sc\`{e}nes dans le dossier \\
}{}
