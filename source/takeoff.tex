...
\item{\texttt{-$ $-enable-splash-screen}, \texttt{-$ $-disable-splash-screen}}
  ...
  启用或禁用（默认）旋转 3DFX 图标并初始化加速板（只用于 3DFX）。
...
\item{\texttt{-$ $-materials-file={\it file}}}
 ...
 指定渲染地景用的材质文件。默认是：\\\texttt{Materials/regions/materials.xml}
...
{
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \section{摇杆支持\label{joysticksupp}}\index{Joystick 摇杆}
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
你能想象一个飞行员只用键盘来控制塞斯纳飞机吗？要想获得更好的飞行体验，你需要一个飞行摇杆/驾驶盘，外加脚舵板。
