...
opzioni della riga di comando e sui file di configurazione
 ...
 \noindent
\ifchinese
第~\ref{flight} 章，\textit{飞行中：仪表、键位和菜单}，描述了如何操作这个程序，
...
\medskip
 ...
 \noindent
\ifchinese
第~\ref{features} 章，\textit{特性}，描述了一些 \FlightGear{} 中特别为高级用户提供的特性。
\fi
...
\textbf{Partie III : Tutorial}
 ...
 \noindent
\ifchinese
第~\ref{tutorials} 章，\textit{教程}，提供了为新飞行员准备的一些教程。
\fi
%\IfLanguageName{english}{
...
\medskip
 ...
 \noindent
\ifchinese
第~\ref{basic} 章，\textit{基础飞行模拟教程}，提供了一份很基础的飞行教程举例讲解在 \FlightGear{} 中如何飞行，并配以丰富的飞机仪表、按钮及其他设备的插图 
\fi
%\IfLanguageName{english}{
...
\medskip
 ...
 \noindent
\ifchinese
第~\ref{crosscountry} 章，\textit{短途转场飞行教程}，从非默认安装旧金山地区出发，做一次短途转场飞行，
\fi
%\IfLanguageName{english}{
...
eseguito con l'installazione di default
 ...
 \noindent
\ifchinese
第~\ref{IFR Tutorial} 章，\textit{IFR 转场飞行教程}，讲述如何使用仪表飞行规则（IFR），在云雾中完成短途转场飞行。
\fi
%\IfLanguageName{english}{
...
\medskip
 ...
 \noindent
\ifchinese
附录~\ref{missed}，\textit{复飞：如果不能正常工作}，我们尝试帮助你解决一些使用 \FlightGear{} 时的常见问题。
\fi
%\IfLanguageName{english}{
...
l'utilizzo di FlightGear
 ...
 \noindent
\ifchinese
最后的附录~\ref{landing}，\textit{降落：离开飞机之前的一些想法}，我们会特别提到 \FlightGear{} 项目的贡献者，同时也想给那些希望贡献到 \FlightGear{} 开发中的人一些信息并告诉大家还有哪些有待完成。
\fi
%\IfLanguageName{english}{
