...
\iflanguage{french}{
\FlightGear{} est un simulateur de vol libre et gratuit d\'{e}velopp\'{e} \`{a} travers Internet
...
\FlightGear{}, la philosophie qui porte le projet et d\'{e}crit les pr\'{}-requis syst\`{e}me.
}{}
 \medskip
...
\iflanguage{french}{
Dans le chapitre ~\ref{prefligh}, \textit{Pr\'{e}évol : installer \FlightGear{}}, vous trouverez les
...
\iflanguage{french}{
  Le chapitre~\ref{takeoff}, \textit{D\'{e}collage : comment démarrer le
  programme}, d\'{e}crit comment lancer le programme une fois installé.
...
\iflanguage{french}{
  ...
  les raccourcis claiver et mes menus}, d\'{e}crit comment utiliser le
  ...
  d'ensemble des entr\'{e}s des menus, des descriptions d\'{e}taill\'{e}s
...
\iflanguage{french}{
  Le chapitre~\ref{features}, \textit{Fonctionnalit\'{e}} d\'{e}crit certaines
...
\iflanguage{french}{
  ...
  offre un tutoriel sur les bases du vol, illustr\'{e} avec de nombreux
...
\iflanguage{french}{
  Dans l'Annexe~\ref{missed}, \textit{Approche manqu\'{e} : si rien ne fonctionne},
  nous essayons de vous aider à surmonter certaines difficult\'{e}s fr\'{e}quemment
...
\iflanguage{french}{
  Nous avons que la plupart des gends d\'{e}testent lire les manuels. Si vous \^{e}tes certain que votre carte graphique prend en charge
  ...
  pré-compilés\index{binaries!pre-compiled}. Ils peuvent \^{e}tre trouv\'{e}, accompagn\'{e}s de leurs instructions d'installation, \'{a}
  l'adresse suivante :
}{}
 \medskip
...
\iflanguage{french}{
  ...
  des détails sur le d\'{e}marrage du simulateur.
}{}
...
\iflanguage{french}{
 ...
 un \oe{}il dans d'autres documentations, notamment en cas de difficult\'{e}s :
}{}
...
\iflanguage{french}{
 ...
 base dans le r\'{e}pertoire \texttt{/FlightGear/Docs} et est \'{e}galement disponible à l'adresse :
}{}
...
\iflanguage{french}{
 \item Des \textbf{documentations utilisateurs} compl\'{e}mentaires sur des fonctionnalit\'{e}s particuli\`{e}res est disponible
