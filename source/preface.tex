...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\ifchinese
\FlightGear{} 是一个自由的飞行模拟器，由互联网上一群对飞行模拟和编程狂热爱好的人开发。这本《FlightGear 指南》希望介绍给初学者如何快速上手 \FlightGear{}，并享受飞行的乐趣。这里不会提供介绍 \FlightGear{} 全部特性和插件的文档，然而会让新手了解如何开始和探索 \FlightGear{} 所提供的各种体验。 
\fi
...
\textbf{Partie III : Tutorial}
 ...
 \noindent
\ifchinese
第~\ref{tutorials} 章，\textit{飞行教程}，提供了为新飞行员准备的教程信息。
\fi
%\IfLanguageName{english}{
...
\medskip
 ...
 \noindent
\ifchinese
第~\ref{basic} 章，\textit{基础飞行模拟教程}，提供了一个基本飞行的教程，以插图的形式举例讲解在 \FlightGear{} 中如何做。 
\fi
%\IfLanguageName{english}{
...
\medskip
 ...
 \noindent
\ifchinese
第~\ref{crosscountry} 章，\textit{短途转场飞行教程}，从默认安装的旧金山地区出发，来做一次短途旅行。
\fi
%\IfLanguageName{english}{
...
eseguito con l'installazione di default
 ...
 \noindent
\ifchinese
第~\ref{IFR Tutorial} 章，\textit{IFR 转场飞行教程}，讲述如何使用仪表飞行规则（IFR），完成类似的短途飞行。
\fi
%\IfLanguageName{english}{
...
\medskip
 ...
 \noindent
\ifchinese
附录~\ref{missed}，\textit{复飞：若一切无法正常工作}，我们尝试帮助你解决一些使用 \FlightGear{} 时的常见问题。
\fi
%\IfLanguageName{english}{
...
\ifchinese
为那些不喜欢阅读从头至尾阅读文档的人准备的，我们建议以下章节，可以让你更简单的飞上蓝天。
\fi
%IfLanguageName{english}{
...
\ifchinese
我们知道大多数人都讨厌阅读手册。如果你确定你的显卡支持 \Index{OpenGL} （请阅读相关文档，比如大多数 \Index{NVIDIA} 显卡）并且使用 Windows、Mac OS-X 或 Linux，那么你至少可以直接跳过这本指南的第一部分，并使用已经编译好的二进制程序\index{binaries!pre-compiled 预编译的!二进制程序}。相关下载和说明可以前往
\fi
%\IfLanguageName{english}{
