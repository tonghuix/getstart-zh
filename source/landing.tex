...
\item In 2002 functional multi-engine support found it's way into
FlightGear. JSBsim is now the default FDM in FlightGear.
\end{itemize}

\item FlightGear now allows flying ILS approaches. ATIS support shows up,
FlightGear features a transponder.
\end{itemize}

\item In fall 2002 support of 'true' 3D panels becomes stable.
\end{itemize}
