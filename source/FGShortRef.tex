...
\textbf{Engine Start:}   & Put ignition switch to BOTH (``\}'' twice). Set mixture to 100\,\%.
...
\end{multicols}
 ...
 and elevator (forwards/backwards). Holding the mouse button down while moving the mouse
 controls the throttle (forwards/backwards) and rudder (left/right). The scrollwheel controls
...
\end{enumerate}
 ...
 \noindent
 Short Reference by M. Basler, S. Buchanan for \FlightGear{} version 1.9.2.\\
