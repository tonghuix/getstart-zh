...
various ways. They may also provide a radio service (called ATIS in the USA) 
...
\index{turn coordinator} Do not overbank. 20$\textdegree$ is a good level of 
bank to get a steady and reliable turn. This it what the turn coordinator is 
used for. On the picture below the indicator shows the airplane is banked 
20$\textdegree$ to the right. This is just fine to turn to the right:
...
seconds to make a 180° turn in the c172p. Whatever the speed or altitude. 
...
The picture below shows the \index{tachometer}
instrument. It displays how fast the engine is turning in hundreds of 
