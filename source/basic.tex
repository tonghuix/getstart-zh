...
\ifchinese
此教程使用的飞行器是\weblong{http://zh.wikipedia.org/wiki/塞斯纳172} {塞斯纳 172P}\footnote{此为中文维基百科链接，英文维基百科链接是 \weblong{http://en.wikipedia.org/wiki/Cessna_172}。塞斯纳 172 型对中国人来说并不陌生，在上世纪八十年代风靡全国的日本电影《追捕》中，杜秋冬人（高仓健饰）就是驾驶塞斯纳 172R 飞机从北海道飞回本州的。——译者注} 型。此机型已被用于很多真实飞行学校中，并且是一款非常好飞的机型。
\fi
\iffalse
\IfLanguageName{english}{
