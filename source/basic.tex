...
mani\`{e}re n\'{e}gative. Later on you can play around with the options and use a
higher resolution, but this obviously adversly affects performance. Cliquez sur le bouton
\button{D\'{e}marrer} et \FlightGear{} d\'{e}marrera avec les options que vous avez
choisi.
}{}
...
\iflanguage{french}{
Si vous rencontrez des difficult\'{e}s à faire fonctionner la derni\`{e}re version de
\FlightGear{} sur votre syst\^{e}me Windows, vous pourriez tender d'essayer une version
avec des pr\'{e}-requis moindres en mati\`{e}re de graphiques (comme par exemple la
...
\button{Weather->Time of Day} from the menu and select \button{Noon}.
...
\weblong{https://www3.bendixking.com/servlet/com.honeywell.aes.utility.PDFDownLoadServlet?FileName=/TechPubs/repository/006-18034-0000_3.pdf}{https://www3.bendixking.com/servlet/com.honeywell.aes.utility\\.PDFDownLoadServlet?FileName=/TechPubs/repository\\/006-18034-0000\_3.pdf}
\section{What Next?}
\label{sec:Poslowie}
