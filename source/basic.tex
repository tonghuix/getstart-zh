...
Most awful is this error: when the airplane plunges to the ground, you move the mouse forwards (push the yoke\index{yoke!to push}). Because you want to move the airplane's nose upwards. Actually you have to do the opposite: move the mouse backwards (pull the yoke \index{yoke!to pull}). 
...
\fotka{fig:36}{Kompas}{tut_36} \longpage
