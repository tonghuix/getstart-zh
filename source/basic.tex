...
\button{ALT}、\button{UP} 和 \button{DN} 按钮用来控制自动驾驶仪，\index{自动驾驶仪!模式!垂直速率模式}要么控制垂直速率（\textcolor{orange}\button{VS}），或者控制高度（\textcolor{orange}\button{ALT}）。要了解更多塞斯纳 172P 自动驾驶仪的高级模式，可以参考此文档：\weblong{https://dealer.bendixking.com/servlet/com.honeywell.aes.utility.PDFDownLoadServlet?FileName=/TechPubs/repository/006-18034-0000_3.pdf}{Bendix King 的网站}
